...
public class CitologiaController {
    ...
    @PostMapping
    public ResponseEntity<CitologiaResponseDTO> registrar(
            @RequestBody @Valid CitologiaRequestDTO dto
    ) {
    ...
    public ResponseEntity<List<CitologiaResponseDTO>> listarPorPaciente(
