...
public class SaudeSexualController {
    ...
    @PostMapping
    public ResponseEntity<SaudeSexualResponseDTO> registrar(
            @RequestBody @Valid SaudeSexualRequestDTO dto
    ) {
    ...
    public ResponseEntity<List<SaudeSexualResponseDTO>> listarPorPaciente(
